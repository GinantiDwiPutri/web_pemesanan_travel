...
<head>
    ...
    <title>Ketentuan Layanan | Berangkut</title>
    <!-- CSS files -->
    ...
    <div class="page page-center">
        <div class="container container-narrow py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    <h2 class="text-center"><strong>Ketentuan Layanan</strong></h2>
                    <div class="markdown">
                        <p style="text-align: justify;">{!! nl2br($web->terms_and_conditions) !!}</p>
                        <hr />
                    </div>
                </div>
            </div>
