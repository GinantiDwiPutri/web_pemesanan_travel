...
@section('content')
    ...
    <section class="home-two-about about-page">
        <div class="home2-about-icon1">
            <img src="{{ asset('assets-landing/images/icons/home2-about-icon1.png') }}" alt="">
        </div>
        <div class="home2-about-icon2">
            <svg width="115" height="77" viewBox="0 0 115 77" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path id="book"
                    ...
                    fill="#094174" fill-opacity="0.6" />
            </svg>
        </div>
        <div class="home2-about-icon3">
            <img src="{{ asset('assets-landing/images/icons/home2-about-icon3.png') }}" alt="">
        </div>
        <div class="home-two-pattern-layer" style="background-image: url(assets-landing/images/shape/home-about-map.png);">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    ...
                    <div class="home-two-about-content">
                        <p>“ Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantiumtheresr doloremque
                            laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto.
                            Lorem ipsum dolor sit amet, consectetur adi- piscing elit. sed do eiusmod tempor incididunt ut
                            labore et dolore magna aliqua. Ut enim ad minim. Exercitation ullam laboris nisi ut ”</p>
                    </div>
                    ...
                    <div class="home-two-about-btn">
                        <div class="btn-group">
                            <div class="header-link-btn"><a href="destination-details.html" class="btn-1"> View
                ...
                <div class="col-lg-6 offset-lg-1">
                    <div class="about-right-image about-right-image-top">
                        <img src="{{ asset('assets-landing/images/gallery/about-01.jpg') }}" alt="photo">
                    </div>
                    <div class="row">
                        <div class="col-lg-6 pr-0">
                            <div class="about-right-image about-right-image-bottom">
                                <img src="{{ asset('assets-landing/images/gallery/about-02.jpg') }}" alt="photo">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="about-right-image about-right-image-bottom">
                                <img src="{{ asset('assets-landing/images/gallery/about-03.jpg') }}" alt="photo">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="align-title">
                        <h5>Tour Guide’s</h5>
                        <h3>Meet Our Excellent Guide’s</h3>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        <div class="tour-guid-image">
                            <img src="{{ asset('assets-landing/images/gallery/tg-1.jpg') }}" alt="image">
                        </div>
                        <div class="tour-guid-content">
                            <span>Tour Guide</span>
                            <a href="tour-guide.html">Jane Cooper</a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="tour-guid-image">
                            <img src="{{ asset('assets-landing/images/gallery/tg-2.jpg') }}" alt="image">
                        </div>
                        <div class="tour-guid-content">
                            <span>Tour Guide</span>
                            <a href="tour-guide.html">Wade Warren</a>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="2000ms">
                        <div class="tour-guid-image">
                            <img src="{{ asset('assets-landing/images/gallery/tg-3.jpg') }}" alt="image">
                        </div>
                        <div class="tour-guid-content">
                            <span>Tour Guide</span>
                            <a href="tour-guide.html">Jenny Wilson</a>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="2500ms">
                        <div class="tour-guid-image">
                            <img src="{{ asset('assets-landing/images/gallery/tg-4.jpg') }}" alt="image">
                        </div>
                        <div class="tour-guid-content">
                            <span>Tour Guide</span>
                            <a href="tour-guide.html">Mamnun Khan</a>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1000ms">
                        <div class="tour-guid-image">
                            <img src="{{ asset('assets-landing/images/gallery/tg-5.jpg') }}" alt="image">
                        </div>
                        <div class="tour-guid-content">
                            <span>Tour Guide</span>
                            <a href="tour-guide.html">Devon Lane</a>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="tour-guid-image">
                            <img src="{{ asset('assets-landing/images/gallery/tg-6.jpg') }}" alt="image">
                        </div>
                        <div class="tour-guid-content">
                            <span>Tour Guide</span>
                            <a href="tour-guide.html">Guy Hawkins</a>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="2000ms">
                        <div class="tour-guid-image">
                            <img src="{{ asset('assets-landing/images/gallery/tg-7.jpg') }}" alt="image">
                        </div>
                        <div class="tour-guid-content">
                            <span>Tour Guide</span>
                            <a href="tour-guide.html">Robert Fox</a>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="tour-guide-container wow fadeInUp" data-wow-delay="00ms" data-wow-duration="2500ms">
                        <div class="tour-guid-image">
                            <img src="{{ asset('assets-landing/images/gallery/tg-8.jpg') }}" alt="image">
                        </div>
                        <div class="tour-guid-content">
                            <span>Tour Guide</span>
                            <a href="tour-guide.html">Jacob Jones</a>
                            <p>Sed ut perspiciatis unde omnis iste natus error sit.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="instagram-container">
            <div class="instagram-content">
                <div class="instagram-image">
                    <img src="{{ asset('assets-landing/images/gallery/ins1.png') }}" alt="image">
                </div>
                <div class="instagram-overlay">
                    <div class="instagram-icon"><a href="{{ asset('assets-landing/images/gallery/ins1.png') }}"
                            class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
            </div>
            <div class="instagram-content">
                <div class="instagram-image">
                    <img src="{{ asset('assets-landing/images/gallery/ins2.png') }}" alt="image">
                </div>
                <div class="instagram-overlay">
                    <div class="instagram-icon"><a href="{{ asset('assets-landing/images/gallery/ins2.png') }}"
                            class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
            </div>
            <div class="instagram-content">
                <div class="instagram-image">
                    <img src="{{ asset('assets-landing/images/gallery/ins3.png') }}" alt="image">
                </div>
                <div class="instagram-overlay">
                    <div class="instagram-icon"><a href="{{ asset('assets-landing/images/gallery/ins3.png') }}"
                            class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
            </div>
            <div class="instagram-content hide">
                <div class="instagram-image">
                    <img src="{{ asset('assets-landing/images/gallery/ins4.png') }}" alt="image">
                </div>
                <div class="instagram-overlay">
                    <div class="instagram-icon"><a href="{{ asset('assets-landing/images/gallery/ins4.png') }}"
                            class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
            </div>
            <div class="instagram-content hide">
                <div class="instagram-image">
                    <img src="{{ asset('assets-landing/images/gallery/ins5.png') }}" alt="image">
                </div>
                <div class="instagram-overlay">
                    <div class="instagram-icon"><a href="{{ asset('assets-landing/images/gallery/ins5.png') }}"
                            class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
            </div>
            <div class="instagram-content hide">
                <div class="instagram-image">
                    <img src="{{ asset('assets-landing/images/gallery/ins6.png') }}" alt="image">
                </div>
                <div class="instagram-overlay">
                    <div class="instagram-icon"><a href="{{ asset('assets-landing/images/gallery/ins6.png') }}"
                            class="lightbox-image" data-fancybox="gallery"><i class="fa-brands fa-instagram"></i></a>
                    </div>
                </div>
            </div>
